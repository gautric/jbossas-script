#!/bin/sh
#
# This script scans a JBoss configuration file into /etc/sysconfig/${JBossServerName}
# and export JBOSS_MODULEPATH variable form it.
# it is executed only if an standalone.sh 

JBOSS_SERVER_NAME=unknow
